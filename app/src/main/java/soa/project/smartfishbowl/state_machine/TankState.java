...
public class TankState
{
   ...
   */
  private static final Map<States, TankState> stateTable = new HashMap<>(
    Map.of(
      States.INIT, new TankState(R.drawable.tank_not_connected, R.string.tank_err, R.string.tank_desc_err),
      States.IDLE, new TankState(R.drawable.tank_okay, R.string.tank_okay),
      States.IDLE_NIGHT, new TankState(R.drawable.tank_okay_night, R.string.tank_okay, R.string.tank_desc_night),
      States.IDLE_MANUAL, new TankState(R.drawable.tank_okay, R.string.tank_okay, R.string.tank_desc_manual),
      ...
      States.FEEDING_FISHES, new TankState(R.drawable.tank_feeding, R.string.tank_okay, R.string.tank_desc_fish_eating)
    )
  );
  public int view;
  public int status;
